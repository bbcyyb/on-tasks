...
function commandParserFactory(Logger, Promise, _) {
    ...
    CommandParser.prototype[ls]= function(data) {
        ...
        try {
            ...
            let result = _parseLsCommandToObject(data);
    ...
    function _parseLsCommandToObject(data) {
        ...
        for(var i = 1; i < array.length; i++) {
            let r = /\s+/g;
            let line = array[i].replace(r," ").split(" ");
            let lineEntity = {};
            for(let col = 0; col < line.length; col++){
                switch(col){
                    case 0:
                        ...
                        lineEntity.permission = {type: type, owner: owner, group: group, other: other};
                        break;
                    case 1:
                        lineEntity.filecount = line[col];
                        break;
                    case 2:
                        lineEntity.user = line[col];
                        break;
                    case 3:
                        lineEntity.group = line[col];
                        break;
                    case 4:
                        lineEntity.size = line[col];
                        break;
                    case 5:
                        break;
                    case 6:
                        break;
                    case 7:
                        lineEntity.datetime = line[5] + " " + line[6] + " " + line[7];
                        break;
                    case 8:
                        lineEntity.name = line[col];
                        break;
                    default:
                        break;
                }
            }
            entity.array.push(lineEntity);
        }
